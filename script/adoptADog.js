...
$(function () {
  $("#murphy")
    .mouseenter(function () {
      $("#poppy").delay(50).fadeTo("slow", 0.5);
      $("#jack").delay(100).fadeTo("slow", 0.5);
      $("#duffy").delay(150).fadeTo("slow", 0.5);
      $("#lucas").delay(200).fadeTo("slow", 0.5);
      $("#jake").delay(250).fadeTo("slow", 0.5);
    })
    .mouseleave(function () {
...
$(function () {
  $("#poppy")
    .mouseenter(function () {
      $("#murphy").delay(50).fadeTo("slow", 0.5);
      $("#jack").delay(100).fadeTo("slow", 0.5);
      $("#duffy").delay(150).fadeTo("slow", 0.5);
      $("#lucas").delay(200).fadeTo("slow", 0.5);
      $("#jake").delay(250).fadeTo("slow", 0.5);
...
$(function () {
  $("#jack")
    .mouseenter(function () {
      $("#murphy").delay(50).fadeTo("slow", 0.5);
      $("#poppy").delay(100).fadeTo("slow", 0.5);
      $("#duffy").delay(150).fadeTo("slow", 0.5);
      $("#lucas").delay(200).fadeTo("slow", 0.5);
      $("#jake").delay(250).fadeTo("slow", 0.5);
    })
...
$(function () {
  $("#duffy")
    .mouseenter(function () {
      $("#murphy").delay(50).fadeTo("slow", 0.5);
      $("#poppy").delay(100).fadeTo("slow", 0.5);
      $("#jack").delay(150).fadeTo("slow", 0.5);
      $("#lucas").delay(200).fadeTo("slow", 0.5);
      $("#jake").delay(250).fadeTo("slow", 0.5);
    })
    .mouseleave(function () {
...
$(function () {
  $("#lucas")
    .mouseenter(function () {
      ...
      $("#poppy").delay(100).fadeTo("slow", 0.5);
      $("#jack").delay(150).fadeTo("slow", 0.5);
      $("#duffy").delay(200).fadeTo("slow", 0.5);
      $("#jake").delay(250).fadeTo("slow", 0.5);
    })
    .mouseleave(function () {
      $("#murphy").delay(250).fadeTo("fast", 1);
...
$(function () {
  $("#jake")
    .mouseenter(function () {
      ...
      $("#jack").delay(150).fadeTo("slow", 0.5);
      $("#duffy").delay(200).fadeTo("slow", 0.5);
      $("#lucas").delay(250).fadeTo("slow", 0.5);
    })
    .mouseleave(function () {
      $("#murphy").delay(250).fadeTo("fast", 1);
      $("#poppy").delay(200).fadeTo("fast", 1);
